...
const PresentBooks = () => {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:8080/presentBooks')
      .then((response) => {
  ...
  const moveToPastBooks = async (bookId) => {
    try {
      await axios.post('http://localhost:8080/moveToPast', { bookId });
            ...
            <div className="book" key={item.id}>
              <div className="bookContent">
                ...
                <div className="bookRightColumn">
                  ...
                  <div className="markAsDoneReading">
                    {isAdmin && (
                      <button
                        onClick={(e) => {
                          e.preventDefault();
                          moveToPastBooks(item.id)
                        }}
                        onMouseEnter={() => markAsReadHover(item.id)}
                        onMouseLeave={markAsReadNoHover}
                        className='markAsDoneReadingButton'
                      >
